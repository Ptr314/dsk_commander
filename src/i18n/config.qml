...
Item {
    ...
    property string FILE_SUPPORTED_name: qsTr("All Supported")
    ...
    property string TYPE_PC_360_I_name: qsTr("360K Interleaved")
    property string TYPE_PC_360_NI_name: qsTr("360K Sequential")
    property string TYPE_GMD_7012_I_name: qsTr("GMD-7012 8\" 256 Kb")
