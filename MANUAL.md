...
- **Цветовая тема** &mdash; системная, светлая или тёмная. Системная тема следует настройкам оформления Windows, macOS и Linux (GNOME, KDE и др.) и переключается автоматически при их изменении. Пункт доступен только в сборках с Qt 6.8 и новее.
